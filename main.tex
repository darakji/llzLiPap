...
%   <= 6 tables+figures combined (currently 5 figures + 1 table = 6, FULL;
%     Fig. 5 is a four-panel figure; the interface-chemistry figure and
%     per-cell table are Supplementary Fig. S1 / Table S2 in si_figures.tex)
...
% main text lives in si_v0.tex (Supplementary Notes 1-7); supplementary
% figures live in si_figures.tex.
% ============================================================================
...
\begin{figure}[htbp]
\centering
\figslot{figs/fig_uq.pdf}{Figure 4 --- to build from \texttt{it6\_final/uq\_fps\_validation/}}
\caption{\textbf{Pre-labelling uncertainty predicts realised DFT error.} Latent-space posterior variance computed before the final round versus the
...
The same trajectories characterise the contact itself (Supplementary
Fig.~S1 and Supplementary Table~S2). In the electrolyte interior 0--2\% of Zr have fewer than six oxygen
...
transport of the vacancy-rich and cubic materials most simulation work
addresses.
